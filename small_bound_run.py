...
plt.xlabel("Timestep")
plt.ylabel("$\\alpha_i$")
plt.savefig('/Users/Ghadi_1/Desktop/ClownFishSchool_small_alpha_history.png')
model.animate(save=True, out_file_path="/Users/Ghadi_1/Desktop/ClownFishSchool_animation_small_3d.mp4", limit_axes=True)